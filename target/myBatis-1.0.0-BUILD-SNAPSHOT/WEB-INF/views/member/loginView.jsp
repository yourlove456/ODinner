...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".kakaoimg").on("click", function(){
			location.href = "https://kauth.kakao.com/oauth/authorize?client_id=f441fdc54da50335f120591d02097237&redirect_uri=http://localhost:8088/login&response_type=code";
			});
