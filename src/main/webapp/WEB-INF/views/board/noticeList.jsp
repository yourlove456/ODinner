 ...
 <div>
  ...
  <section id="container">
   <form role="form" method="get">
    ...
    <c:if test="${member.verify == 1 }"><a href="/board/noticeWriteView" style="float:right">공지사항 작성</a></c:if>
    <c:if test="${member.verify == 2 }"><a href="/board/noticeWriteView" style="float:right">공지사항 작성</a></c:if>
