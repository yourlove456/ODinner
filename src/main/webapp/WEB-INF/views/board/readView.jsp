   ...
   <body>
      ...
      <div class="container" style="margin-left:500px;">
         ...
         <section id="container">
           ...
           <br>
            ...
            <div class="form-group">
               ...
               <input type="text" id="writer" name="writer" class="form-control" value="${read.writer}"  readonly="readonly" style="width:150px;"/>
            </div>
            <div class="form-group">
        ...
        <div>
            ...
            <div>
               <c:if test="${member.userName == read.writer}"><button type="button" class="update_btn btn btn-warning">수정</button></c:if>
               <c:if test="${member.userName == read.writer}"><button type="button" class="delete_btn btn btn-danger">삭제</button></c:if>
                  ...
                  <c:forEach items="${replyList}" var="replyList">
                     <li>
                        ...
                        <div class="div2"><%@include file="replyDeleteView.jsp" %></div>
                           <c:if test="${member.userName == replyList.writer}"><button type="button" class="btn btn-warning btnShow">수정</button></c:if>
                           <c:if test="${member.userName == replyList.writer}"><button type="button" class="btn btn-danger btnShow2">삭제</button></c:if>
                        </div>
                     </li>
                  </c:forEach>   
               </ol>
